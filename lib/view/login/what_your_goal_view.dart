...
class _WhatYourGoalViewState extends State<WhatYourGoalView> {
  ...
  int _selectedExercise = 0; // Variable to store selected exercise
            ...
            child: CarouselSlider(
              ...
              options: CarouselOptions(
                ...
                onPageChanged: (index, reason) {
                  setState(() {
                    _selectedExercise = index; // Update the selected index
                  });
                },
              ),
            ),
                ...
                RoundButton(
                    ...
                    onPressed: () async {
                      await prefs.setString(
                          'selectedgoal', goalArr[_selectedExercise]["title"]);
                      Navigator.push(
                          context,
                          MaterialPageRoute(
