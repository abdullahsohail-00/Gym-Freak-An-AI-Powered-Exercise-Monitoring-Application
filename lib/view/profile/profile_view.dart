...
import 'package:fitness/view/login/update_profile_view.dart';
...
class _ProfileViewState extends State<ProfileView> {
  String selectedGoal =
      prefs.getString('selectedgoal').toString(); // Default selected goal
  bool positive = false;
                ...
                children: [
                  Expanded(
                    child: TitleSubtitleCell(
                      title: prefs.getString('height') ?? "0",
                      subtitle: "Height",
                    ),
                  ),
                  SizedBox(
                  ...
                  Expanded(
                    child: TitleSubtitleCell(
                      title: prefs.getString('weight') ?? "0",
                      subtitle: "Weight",
                    ),
                  ),
                  // SizedBox(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildGoalRow("Improve Shape"),
                    _buildGoalRow("Lean & Tone"),
                    _buildGoalRow("Lose Fat"),
                  ],
                ),
              ),
              const SizedBox(
                            ...
                            SizedBox(
                              ...
                              child: RoundButton(
                                ...
                                onPressed: () {
                                  ...
                                  //   context,
                                  //   MaterialPageRoute(
                                  //     builder: (context) => const SelectView(cameras: ,),
                                  //   ),
                                  // );
                                },
                              ),
  ...
  Widget _buildGoalRow(String goal) {
    return Row(
